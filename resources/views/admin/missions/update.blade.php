                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="card shadow border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                <form enctype="multipart/form-data" method="post" action="{{ route('missions.update') }}">
                                    @csrf
                                    <div class="form-floating mb-3">
                                        ...
                                        rows="3"> {{ $missions->content }} </textarea>
                                        @error('content')
                                    ...
                                    <div class="mb-3">
                                        <span>Vidéo</span>
                                        <input class="form-control @error('video') is-invalid @enderror" id="video" type="file" name="video" />
                                        @error('video')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
